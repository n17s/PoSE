...
deepspeed src/train_phi3mini.py \
    --model_name_or_path $prefix/2024_03_26/phi3_phase2v1_2_3_8b_phase2/hf_version/ \
    ...
    --output_dir $prefix/pose/results/phi3mini-4k-$((factor*4))k-${rope_type} \
    --max_steps 1000 \
    --model_max_position_embeddings 4096 \
    --inference_length $((factor*4096)) \
